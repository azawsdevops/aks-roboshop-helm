...
argocd app create $app_name --repo https://github.com/kp3073/aks-roboshop-helm.git --dest-namespace default --dest-server https://kubernetes.default.svc --values $env/$app_name.yaml --path . --helm-set appImage=$appImage
